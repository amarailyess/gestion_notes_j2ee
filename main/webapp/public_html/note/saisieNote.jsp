...
<div class="card">
 <div class="card-header">
    Saisir des notes pour l'etudiant(e): <a href="#" class="alert-link">${nom_etudiant}(${immat_etudiant}) </a> 
  </div>
  <div class="card-body">
 
      <form action="sauv_notes.do" method="post">
       <input type="hidden" name="immat_etudiant" value="${immat_etudiant}" class="form-control"/>
       <input type="hidden" name="nom_etudiant" value="${nom_etudiant}" class="form-control"/>
      ...
      <div>
        <button type="submit" class="btn btn-success">Ajouter</button>
         <a href="notes_etudiant.do?immatricule=${immat_etudiant}" class="btn btn-danger">Annuler</a>
      </div>
      </form>   
