...
<div class="sidebar" data-color="green" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
    ...
    <div class="sidebar-wrapper">
      <ul class="nav">
        ...
        <li class="nav-item " >
          <a class="nav-link" href="matiere.do">
        ...
        <li class="nav-item " >
          <a class="nav-link" href="enseignant.do">
            <i class="fa fa-user"></i>
            <p>Enseignants</p>
          </a>
        </li>
        <li class="nav-item ">
          <a class="nav-link" href="etudiants.do">
            <i class="fa fa-users"></i>
            <p>Etudiants</p>
          </a>
        </li>
        <li class="nav-item ">
          <a class="nav-link" href="notes.do">
            <i class="fa fa-sticky-note"></i>
            <p>Notes</p>
          </a>
        </li>
        <li class="nav-item ">
          <a class="nav-link" href="admins.do">
            <i class="fa fa-user"></i>
            <p>Admins</p>
          </a>
        </li>
